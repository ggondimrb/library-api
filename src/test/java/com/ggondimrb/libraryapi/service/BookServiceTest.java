...
import com.ggondimrb.libraryapi.service.impl.BookServiceImpl;
...
public class BookServiceTest {
	...
	public void saveBookTest() {
		...
		//mockito para testes unitarios / bdd para testes integrados
		Mockito.when(repository.existsByIsbn(Mockito.anyString())).thenReturn(false);
		Mockito.when(repository.save(book)).thenReturn(Book.builder().id(11L).isbn("123").author("Fulano").title("As aventuras").build());
	...
	@Test
	@DisplayName("Deve ocorrer erro ao tentar deletar um livro inexistnte")
	...
	@Test
	@DisplayName("Deve ocorrer erro ao tentar atualizar um livro inexistnte")
